        ...
        >
          ...
          {searchMode === 'image' ? (
            <label className="flex h-full min-w-0 flex-1 cursor-pointer items-center px-4 text-sm font-semibold text-ink-secondary">
              ...
              />
              <span className="truncate">{selectedFile?.name ?? 'Choose an image'}</span>
            </label>
          ) : (
            <input
              ...
              value={query}
              placeholder={searchMode === 'semantic' ? 'Search by description...' : 'Search text in images...'}
        ...
        <nav className="flex shrink-0 items-center gap-1.5">
          ...
          {isAuthenticated ? (
            ...
            >
              ...
              >
                <div role="menu" className="rounded-2xl border border-border bg-white p-2 text-left shadow-xl shadow-slate-200/80">

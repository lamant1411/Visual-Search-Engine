...
const sizeClasses: Record<ButtonSize, string> = {
    ...
    md: 'px-4 py-2 text-sm min-h-10 gap-2',
    lg: 'px-6 py-3 text-base min-h-12 gap-2.5',
    icon: 'w-10 h-10 p-0 justify-center shrink-0',
}
    ...
    ({ variant = 'primary', size = 'md', loading = false, leftIcon, rightIcon, fullWidth = false, disabled, children, className = '', ...props }, ref) => {
        ...
        return (
            <button
                ...
                disabled={isDisabled}
                className={[
                    'inline-flex items-center justify-center font-semibold rounded-[10px] whitespace-nowrap',

...
export function ResultCard({
  ...
  return (
    <article
      className={[
        "group relative mb-5 block w-full break-inside-avoid overflow-hidden rounded-lg bg-white text-left shadow-sm shadow-slate-200/70 ring-1 ring-white/70 transition duration-200 md:hover:-translate-y-0.5 md:hover:shadow-lg md:hover:shadow-slate-200/90",
